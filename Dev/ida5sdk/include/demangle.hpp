/*
 *      CPP Demangler.
 *      Copyright (c) 2000-2006 by Iouri Kharon.
...
#define MT_MEMBER    0x00000080 // 4 - undetermined (bc/wat)
...
//#define MT_         0x40000000  // 4 - reserved
...
//       bit is not set.
// NOTE: if long(answer_length) < 0 then the buffer size will be -answer_length
...
void init_demangler(bool mode16);
