...
idaman ssize_t ida_export get_predef_insn_cmt(insn_t &cmd,
                                              char *buf,
                                              size_t bufsize);
...
idaman ssize_t ida_export get_predef_cmt(const char *info,
                                         int wrktyp,
                                         char *buf,
                                         size_t bufsize);
...
#ifdef _IDP_HPP
inline char *idaapi get_vxd_func_name(int vxdnum,
                                      int funcnum,
                                      char *buf,
                                      size_t bufsize)
{
