...
SPARC_fmuld8sux16,   // Signed upper 8/16-bit multiply Õ 32-bit partitioned product of components 
SPARC_fmuld8ulx16,   // Unsigned lower 8/16-bit multiply Õ 32-bit partitioned product of components
