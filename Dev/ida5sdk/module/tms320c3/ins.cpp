...
{ "db",		CF_USE1|CF_USE2|CF_JUMP		},	// Decrement and branch conditionally
...
{ "",		0				},	// Pseudo cmd (more accurate definition need)
{ "",		0				},	// Pseudo cmd (move to next index need)
};


#ifdef __BORLANDC__
#if qnumber(Instructions) != TMS320C3X_last
