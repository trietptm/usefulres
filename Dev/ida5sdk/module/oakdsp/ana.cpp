...
struct opcode
{
  ...
  ushort cycles;     //Number of cycles
  ulong mask;
  ulong value;
};
...
//----------------------------------------------------------------------
static ulong ua_32bits(void)
{

  ulong x =             ( (get_full_byte(cmd.ea)                ) & 0x0000FFFF )
                        |       ( (get_full_byte(cmd.ea+1) << 16) & 0xFFFF0000 );

/*
  ulong x =             (   (get_full_byte(cmd.ea)   >> 8 ) & 0x000000FF )
...
//----------------------------------------------------------------------
static bool sdirect(int value,int param)
{
...
//----------------------------------------------------------------------
static bool ldirect(int value,int param)
{
...
//----------------------------------------------------------------------
static bool A(int value,int param)
{
	return( rrrrr(value & 0x01, A0 + mix_mode) );
}
//----------------------------------------------------------------------
static bool B(int value,int param)
{
	return( rrrrr(value & 0x01, B0 + mix_mode) );
}
//----------------------------------------------------------------------
static bool mmnnn(int value,int param)
{
        if ((value & 0x07) > 0x05)
                return false;
...
//----------------------------------------------------------------------
static bool nnn(int value,int param)
{
...
//----------------------------------------------------------------------
static bool ALB(int value,int param)
{
...
//----------------------------------------------------------------------
static bool s_Imm(int value, int param)
{
        op->type  = o_imm;
        op->value = value;
...
//----------------------------------------------------------------------
static bool l_Imm(int value, int param)
{
        op->type  = o_imm;
...
//----------------------------------------------------------------------
static bool rb_rel_short(int value, int param)
{
        op->type   = o_local;
...
//----------------------------------------------------------------------
static bool rb_rel_long(int value, int param)
{
        int16 tmp;
...
//----------------------------------------------------------------------
static bool lim_xx(int value, int param)
{
...
//----------------------------------------------------------------------
static bool rI(int value,int param)
{
        //iiqq
...
//----------------------------------------------------------------------
static bool AB(int value,int param)
{
...
//----------------------------------------------------------------------
static bool ABLH(int value,int param)
{
...
//----------------------------------------------------------------------
static bool laddr_pgm(int value,int param)
{
...
//----------------------------------------------------------------------
static bool addr_rel_pgm(int value, int param)
{
        value = (value & 0x7f);
        op->amode |= amode_p;
...
//----------------------------------------------------------------------
static bool ext_XX(int value, int param)
{
	return( rrrrr( (value & 0x01) + ((value & 0x04) >> 1), EXT0 + mix_mode) );
}
//----------------------------------------------------------------------
static bool context(int value,int param)
{
        if (value)
...
//----------------------------------------------------------------------
static bool swap(int value,int param)
{
...
//----------------------------------------------------------------------
static bool banke(int value,int param)
{
...
//----------------------------------------------------------------------
static bool cntx(int value,int param)
{
...
//----------------------------------------------------------------------
static bool dmod(int value,int param)
{
        op->type   = o_textphrase;
        op->phrase = value;
        op->phtype = text_dmod;
...
//----------------------------------------------------------------------
static bool eu(int value,int param)
{
        op->type   = o_textphrase;
        op->phtype = text_eu;
        return true;
