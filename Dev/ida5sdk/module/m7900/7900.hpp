...
inline void TRACE1(char *szStr)
{
  char szTemp[20];
  qsnprintf(szTemp, sizeof(szTemp), "%s\n", szStr);
  msg(szTemp);
}


inline void TRACE1(ulong Data)
{
  char szTemp[20];
  qsnprintf(szTemp, sizeof(szTemp), "DATA - %X\n", Data);
  msg(szTemp);
}


inline void TRACE(char *szStr)
{
  char szTemp[20];
  qsnprintf(szTemp, sizeof(szTemp), "%s\n", szStr);
//  msg(szTemp);
...
inline int GETBIT(ulong Data, int bit)
{
 ulong TempByte;
 TempByte = Data;
