...
//----------------------------------------------------------------------
inline int op_s1(void) {  return int((code>>11)) & 31; }
inline int op_ds(void) {  return int((code>>16)) & 31; }
inline int op_s2(void) {  return int((code>>21)) & 31; }
    ...
    case 0x1C: case 0x1D: case 0x1E:
      {
        ...
        if ( isDS() ) break;
        cmd.itype = ((code & Pbit) ? Pintrs : Mintrs)[ int(code) & 0xF ];
      }
common3:
      op_fs1(cmd.Op1);
      op_fs2(cmd.Op2);
