...
#define JDK_MAX_MAJOR     50    // JDK1.6(JDK6): Java5.1
//
// access_flags
//
...
#define j_func          '('     //start of function parameters
#define j_endfunc       ')'     //end of function parameters
...
#define j_clspath_dlm   '/'     // uase ass classpath delimeter
