...
//--------------------------------------------------------------------------
static void simplify(ulong code)
{
  switch ( cmd.itype )
  {
...
//--------------------------------------------------------------------------
static void opr(op_t &x, ulong rgnum)
{
  x.reg = rgnum;
/*  if ( rgnum == 0 )
  {
...
inline sval_t s17(ulong i17){ return (i17  & 0x10000) ? (i17  | ~sval_t(0x1FFFF)) : i17;   }
inline sval_t s22(ulong i22){ return (i22 & 0x200000) ? (i22 | ~sval_t(0x3FFFFF)) : i22;   }
...
//--------------------------------------------------------------------------
static void handle_float_0C(ulong code)
{
  int uid = (code>> 6) & 7;
...
//--------------------------------------------------------------------------
static void handle_float_0E(ulong code)
{
  int cls = (code>>9) & 3;
  switch ( cls )
  {
