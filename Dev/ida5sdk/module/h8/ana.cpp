...
{
  ulong prefix;
  ulong mask;           // bit set means that the bit is ignored
  map_t *map;
};
...
//--------------------------------------------------------------------------
static void opreg8(op_t &x, int reg)
{
  x.type = o_reg;
  x.dtyp = dt_byte;
  x.reg  = reg;
...
//--------------------------------------------------------------------------
inline int r0(void) { return advanced() ? ER0 : R0; }
...
//--------------------------------------------------------------------------
static void oppost(op_t &x, int reg, char dtyp)
{
  x.type   = o_phrase;
  x.dtyp   = dtyp;
  x.reg    = reg;
...
//--------------------------------------------------------------------------
static void opreg(op_t &x, int reg, char dtyp)
{
  switch ( dtyp )
  {
    case dt_byte:
