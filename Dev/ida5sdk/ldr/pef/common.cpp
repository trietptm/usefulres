...
//----------------------------------------------------------------------
static char *get_string(linput_t *li,
                        long snames_table,
                        long off,
                        char *buf,
                        size_t bufsize)
...
//----------------------------------------------------------------------
inline char *get_impsym_name(char *stable,uint32 *impsym,int i)
{
  return stable+(mflong(impsym[i]) & 0xFFFFFFL);
}
...
//----------------------------------------------------------------------
static char *get_expsym_name(char *stable,
                             uint32 *keytable,
                             pef_export_t *pe,
                             int i,
                             char *buf,
                             ssize_t bufsize)
{
  ...
  ssize_t len = get_expsym_name_length(keytable,i);
  if ( len >= bufsize )
    len = bufsize-1;
