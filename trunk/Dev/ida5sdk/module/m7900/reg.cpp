...
extern  const bool mitsubishi_find_ioport_bit(int port, int bit);
//----------------------------------------------------------------------
...
//------------------------------------------------------------------
const bool mitsubishi_find_ioport_bit(int port, int bit)
{
    ...
    case processor_t::newfile:
     {
      ...
      if (choose_device())
        ...
        //      0 for fM and fX
	     ...
	     {
                SetDefaultRegisterValue(getnseg(i), rDPR0, 0x0);
                SetDefaultRegisterValue(getnseg(i), rDPR1, 0x0);
                SetDefaultRegisterValue(getnseg(i), rDPR2, 0x0);
                SetDefaultRegisterValue(getnseg(i), rDPR3, 0x0);
                SetDefaultRegisterValue(getnseg(i), rDT, 0x0);
                SetDefaultRegisterValue(getnseg(i), rPG, 0x0);
                SetDefaultRegisterValue(getnseg(i), rPC, 0xFFFE);
                SetDefaultRegisterValue(getnseg(i), rPS, 0x0FFF);

                SetDefaultRegisterValue(getnseg(i), rfI, 1);
                SetDefaultRegisterValue(getnseg(i), rfD, 0);
                SetDefaultRegisterValue(getnseg(i), rfX, 0);
                SetDefaultRegisterValue(getnseg(i), rfM, 0);
                SetDefaultRegisterValue(getnseg(i), rfIPL, 0);

                SetDefaultRegisterValue(getnseg(i), rDPReg, 1);
            }
...
//             for (ea_t x = ea1; x < ea2; x = nextthat(x, ea2, isCode))                        do_unknown(x, false);
          }
       }
       break;
