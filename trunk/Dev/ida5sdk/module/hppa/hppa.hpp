...
inline int opcode(ulong code) { return (code>>26) & 0x3F; }
inline int r06(ulong code) { return (code>>21) & 0x1F; }
inline int r11(ulong code) { return (code>>16) & 0x1F; }
inline int r22(ulong code) { return (code>> 5) & 0x1F; }
inline int r27(ulong code) { return (code>> 0) & 0x1F; }
inline int get11(ulong code)  // 11bit field for branches
{
  return ((code>>3) & 0x3FF) | ((code&4)<<(10-2));
}
inline long get17(ulong code)
{
  return ((code&1) << 16)
       | (r11(code) << 11)
       | get11(code);
}
inline sval_t as21(ulong x)
{
  //           1         2
...
inline int get_ldo(ulong code) { return assemble_16((code>>14)&3,code & 0x3FFF); }

//--------------------------------------------------------------------------

char *build_insn_completer(ulong code, char *buf, size_t bufsize);
