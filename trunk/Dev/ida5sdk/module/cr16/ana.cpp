...
static int near Rproc(uchar code)
{
switch(code){
...
static void near SetImmData(op_t &op, signed long code, int bits)
{
        // fix sign
...
static void near SetRelative(op_t &op, signed long disp, int bits)
{
op.type=o_near;
op.dtyp=dt_word;
