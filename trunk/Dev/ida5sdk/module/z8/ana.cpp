...
int ana( void )
{
  ...
  if( nibble0 == 0xF )      // xF
  {
    static char cmdxF[] = { Z8_null, Z8_null, Z8_null, Z8_null,
  ...
  {
    static char cmdx8E[] = { Z8_ld, Z8_ld, Z8_djnz, Z8_jrcond, Z8_ld,
                             Z8_jpcond, Z8_inc };
...
//        cmd.Op2.n = 1;
  ...
  {
    static char cmdx2[] = { Z8_add,  Z8_adc,  Z8_sub, Z8_sbc,
  ...
  {                                                    /*Z8_srp*/
    static char cmdx01[] = { Z8_dec,  Z8_rlc, Z8_inc,  Z8_jp,
