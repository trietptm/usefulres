...
const atype_t           // priority,  description
  ...
  AU_PROC = 30,         //  2 convert to procedure start
  AU_TAIL = 35,         //  3 add a procedure tail
  AU_TRSP = 38,         //  4 trace stack pointer (not used yet)
  AU_USED = 40,         //  5 reanalyze
  AU_TYPE = 50,         //  6 apply type information
  AU_LIBF = 60,         //  7 apply signature to address
  AU_LBF2 = 70,         //  8 the same, second pass
  AU_LBF3 = 80,         //  9 the same, third pass
  AU_CHLB = 90,         // 10 load signature file (file name is kept separately)
  AU_FINAL=200;         // 11 final pass
