...
void idaapi run(int /*arg*/)
{
  ...
  if ( hwnd != NULL )
  {
    ...
    if ( gv != NULL )
    {
      ...
      viewer_add_menu_item(gv, "User function", menu_callback, gv, 0);
    }
  }
  else
  {
...
//--------------------------------------------------------------------------
char comment[] = "This is a sample graph plugin.";
...
char wanted_name[] = "Create sample graph view";
