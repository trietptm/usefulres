...
//-----------------------------------------------------------------------
static void show_segdefs(linput_t *li, ulong offset, ulong length)
{
...
//-----------------------------------------------------------------------
static void show_pubdefs(linput_t *li, ulong offset, ulong length)
{
  if ( offset == 0 || length == 0 ) return;
  qlseek(li, offset);
  for ( int i=0; i < length; )
...
//-----------------------------------------------------------------------
static void show_extdefs(linput_t *li, ulong offset, ulong length)
{
  if ( offset == 0 || length == 0 ) return;
  qlseek(li, offset);
...
//-----------------------------------------------------------------------
static void show_txtfixs(linput_t *li, ulong offset, ulong length)
{
  if ( offset == 0 || length == 0 ) return;
  qlseek(li, offset);
  ulong eoff = offset + length;
