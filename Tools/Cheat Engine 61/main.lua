...
DataType=getMainForm() 
Cn_Combobox=component_findComponentByName(DataType, "VarType") 
Cn_Items=combobox_getItems(Cn_Combobox) 
strings_setString(Cn_Items, 0, '二进制') 
strings_setString(Cn_Items, 1, '字节') 
strings_setString(Cn_Items, 2, '2 字节') 
strings_setString(Cn_Items, 3, '4 字节') 
strings_setString(Cn_Items, 4, '8 字节') 
strings_setString(Cn_Items, 5, '浮点数') 
strings_setString(Cn_Items, 6, '双浮点数') 
strings_setString(Cn_Items, 7, '文本') 
strings_setString(Cn_Items, 8, '字节数组') 
strings_setString(Cn_Items, 9, '全部 (字节到双浮点)') 
